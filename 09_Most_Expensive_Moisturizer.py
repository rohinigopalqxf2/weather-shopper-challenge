...
3) Select  the most expensive product i.e moisturizer from the screen 
...
def get_most_expensive_moisturizer():
...
#click add for most expensive moisturizer           
...
if __name__=='__main__':
    get_most_expensive_moisturizer()
